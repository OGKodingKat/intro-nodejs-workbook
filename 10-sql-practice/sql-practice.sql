...
SELECT AVG(released_year) AS average_release_year
...
SELECT programming_languages.name AS language, 
       programming_languages.released_year, 
       developers.name AS creator, 
       developers.country
FROM programming_languages
